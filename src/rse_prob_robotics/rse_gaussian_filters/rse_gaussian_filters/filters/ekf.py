...
def _normalize_angle(angle):
	"""Wrap angle to (-pi, pi] — mirrors kf.py, prevents unbounded angular drift."""
...
class ExtendedKalmanFilter:
	...
	def predict(self, u, dt):
		...
		# Normalize theta after update — prevents unbounded heading drift
	...
	def update(self, z, dt):
		...
		# Normalize theta after update — innovation may wrap around
		self.mu[2] = _normalize_angle(self.mu[2])
