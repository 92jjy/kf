...
class Visualizer:
    def __init__(self):
        ...
        # Blue line for Kalman filter path — prominent, thick, on top
        self.kf_line, = self.ax.plot([], [], [],
                                     color='#1f77b4', linewidth=2.5,
                                     label='Kalman Filter', zorder=3)
        ...
        # visible even when it overlaps the blue KF line
        ...
        self.ax.set_zlabel('Z coordinate (m)', fontsize=11)
        self.ax.tick_params(axis='both', which='major', labelsize=9)
        self.ax.set_title('Kalman Filter 3D Trajectory Estimation',
        ...
        self.fig.canvas.set_window_title('Kalman Filter 3D Estimation')
        self.fig.show()
